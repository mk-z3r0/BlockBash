...
ASSERTING+=(level-data-probe level-select-probe enemy-collision-probe level-editor-probe boss-fight-probe story-beats-probe progression-chain-probe respawn-state-probe full-playthrough-probe)
